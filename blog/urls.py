...
from .views import (
    IndexView, PostDetailView, CategoryListView,
    TagListView, CategoryPostView, TagPostView,
    SearchPostView, CommentFormView, comment_approve,
    comment_remove, ReplyFormView, reply_approve,
    reply_remove)


app_name = 'blog'
urlpatterns = [
    path('', IndexView.as_view(), name='post_detail'),
